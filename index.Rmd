...
<a href="https://amzn.to/2WoabjB"><img src="cover.png" width="250" height="366" class="cover" alt="Buy on Amazon" /></a> This is an edited and customized version of  __"[Advanced R](https://amzn.to/2WoabjB)"__ by Hadley Wickham. Advanced R is written primarily for R users who want to improve their programming skills and understanding of the language. This edited version narrows the scope of the original Advanced R textbook in order to augment the coverage of topics most relevant to students in SDS 270 (Programming for Data Science in R) at Smith college.

If you're looking for unedited 2nd edition, you can find it at <https://adv-r.hadley.nz/>.
